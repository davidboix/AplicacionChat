 ...
 *
 */
public class Atendre_ClientsProves extends Thread {

    private Socket socket;
    private ArrayList<String> arrMsg = new ArrayList<>();
    private ArrayList<Socket> arrSocket = new ArrayList<>();

    public Atendre_ClientsProves() {

    }

    public Atendre_ClientsProves(Socket socket) {
        this.socket = socket;
    }

    public Atendre_ClientsProves(Socket socket, ArrayList<Socket> arrSocket) {
        this.socket = socket;
        this.arrSocket = arrSocket;
        
    }

    public Atendre_ClientsProves(Socket socket, ArrayList<Socket> arrSocket, ArrayList<String> arrMsg) {
        this.socket = socket;
        this.arrSocket = arrSocket;
        this.arrMsg = arrMsg;
    }
...
//    private CopyOnWriteArrayList<String> arrMsg;
//
//    public Atendre_Clients(Socket socket, CopyOnWriteArrayList<Socket> arrSocket, CopyOnWriteArrayList<String> arrMsg) {
//        this.socket = socket;
//        this.arrSocket = arrSocket;
//        this.arrMsg = arrMsg;
//    }
...
//            DataInputStream dis = new DataInputStream(socket.getInputStream());
//            while (true) {
//                String mensaje = dis.readUTF(); // Lee mensaje del cliente
//                System.out.println("Mensaje recibido: " + mensaje);
//
//                arrMsg.add(mensaje);
//
//                // Crear un nuevo hilo para enviar mensajes a todos los clientes
//                new FilsEnviarInfoClients(mensaje,arrSocket).start();
////                FilsEnviarInfoClients hiloEnvio = new FilsEnviarInfoClients(mensaje, arrSocket);
////                hiloEnvio.start();
//            }
//        } catch (IOException e) {
//            e.printStackTrace();
