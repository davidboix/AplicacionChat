...
public class ServidorProves {
     ...
     * @param qtClients
     */
    public ServidorProves(int qtClients) {
    ...
    public static void setIpServidor(String ipServidor) {
        ServidorProves.ipServidor = ipServidor;
    }
...
//    private static int qtClients;
//    public static String ipServidor;
//    private CopyOnWriteArrayList<Socket> arrSocket = new CopyOnWriteArrayList<>();
//    private CopyOnWriteArrayList<String> arrMsg = new CopyOnWriteArrayList<>();
//
//    public Servidor() {}
//
...
//                Socket newSocket = serverSocket.accept();
//                servidor.augmentarClientsConnectats();
//                servidor.arrSocket.add(newSocket);
//
