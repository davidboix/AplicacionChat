 ...
 * @version 1.0
 */
public class ServidorProvisional {

    private String ipServidor;
    private int portServidor;

    public ServidorProvisional() {
     ...
     * @param portServidor
     */
    public ServidorProvisional(String ipServidor, int portServidor) {
    ...
    private void encriptarPassword(String missatge, Socket socket, ServidorProvisional servidor, SecretKey clau, byte[] msgEncriptat, Cipher aesCipher, DataOutputStream out) {
    ...
    public static void main(String[] args) {
        ...
        ServidorProvisional servidor = new ServidorProvisional();
